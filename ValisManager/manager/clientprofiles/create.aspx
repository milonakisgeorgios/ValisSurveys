<%@ Page Title="" Language="C#" MasterPageFile="~/manager/Manager.Master" AutoEventWireup="false" CodeBehind="create.aspx.cs" Inherits="ValisManager.manager.clientprofiles.create"  ClientIDMode="Static"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form-header">
        <span class="form-header-title">Add A New Profile</span>
        <a class="form-header-link" href=<%=_UrlSuffix("list.aspx") %>">(back to profiles list)</a>
