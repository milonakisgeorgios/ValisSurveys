<%@ Page Title="" Language="C#" MasterPageFile="~/manager/Manager.Master" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="ValisManager.manager.customers.contacts.edit" %>
    ...
    <script>
        ...
        function OnUnlockUser() {
            showQuestion("Are you sure you want to unlock this user?", function () {
                ...
                var _url = theManagerPath + 'services/api/Clients/UnlockUser?ScId=' + theAccessToken;
        ...
        function OnChangePasswordButton()
        {
            ...
            var _url = theManagerPath + 'services/api/Clients/SetNewPswd?ScId=' + theAccessToken;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form-header">
        ...
        <a class="form-header-link" href="../edit.aspx?ClientId=<%=this.SelectedUser.Client %>&<%=this.UrlSuffix %>">(back to customer details)</a>
