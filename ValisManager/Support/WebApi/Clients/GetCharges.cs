...
{
    /// <summary>
    /// Επιστρέφει όλα το VLCharge απο ανήκουν σε έναν συγκεκριμένο Πελάτη
    /// </summary>
    public class GetCharges : WebApiHandler
    {
        ...
        protected override void ProcessGetRequestWrapped(Valis.Core.VLAccessToken accessToken, HttpContext context)
        {
            ...
            int totalRecords = 0;
            var items = systemManager.GetChargesForClient(clientId, pageIndex, pageSize, ref totalRecords, string.Empty, orderByClause);
