...
*/
function File(filePath, fileSize, modTime, w, h, fileid, url){
  ...
  this.url = (url ? url : '');
  this.Show = function(){
    html = '<li data-fileid="' + this.fileid + '" data-url="' + this.url + '" data-path="' + this.fullPath + '" data-time="' + this.time + '" data-icon="' + this.icon + '" data-w="' + this.width + '" data-h="' + this.height + '" data-size="' + this.size + '" data-icon-big="' + (this.IsImage() ? this.fullPath : this.bigIcon) + '" title="' + this.name + '">';
  ...
  this.Delete = function(){
    ...
    var deleteUrl = RoxyUtils.AddParam(RoxyFilemanConf.DELETEFILE, 'fileid', this.fileid);
    deleteUrl = RoxyUtils.AddParam(deleteUrl, 'scId', RoxyUtils.GetUrlParam('scId'));
    deleteUrl = RoxyUtils.AddParam(deleteUrl, 'survey', RoxyUtils.GetUrlParam('survey'));
    var item = this;
    $.ajax({
        url: deleteUrl,
        dataType: 'json',
  ...
  this.Rename = function(newName){
    ...
    url = RoxyUtils.AddParam(url, 'survey', RoxyUtils.GetUrlParam('survey'));
    var item = this;
    var ret = false;
    $.ajax({
        url: url,
