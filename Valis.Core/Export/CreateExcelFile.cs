...
namespace Valis.Core.Export
{
    ...
    {
        static ILog Logger = LogManager.GetLogger(typeof(CreateExcelFile));
        ...
        public static bool CreateExcelDocument<T>(IEnumerable<T> list, string filename, System.Web.HttpResponse Response)
        {
            //try
            // {
            DataSet ds = new DataSet();
